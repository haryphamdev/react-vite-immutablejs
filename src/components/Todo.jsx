...
export default class Todo extends PureComponent {
  ...
  render() {
    ...
    console.log(">>> check raw single todo 111: ", this.props.todo)
    console.log(">>> check raw single todo id =: ", this.props.todo.get("id"))
    console.log(">>> check raw single todo text =: ", this.props.todo.get("text"))
    console.log(">>> check raw single todo isCompleted =: ", this.props.todo.get("isCompleted"))
